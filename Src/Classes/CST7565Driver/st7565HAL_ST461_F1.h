...
#define ST7565_BIT_A0 GPIO_Pin_6

#define ST7565_SPI SPI2
#define ST7565_CHANNEL_SPI SPI2
#define ST7565_CHANNEL_RCC_SPI RCC_APB1Periph_SPI2
...
public:
	...
	static inline void halInit() {
		...
		RCC_APB1PeriphClockCmd(ST7565_CHANNEL_RCC_SPI, ENABLE);
	...
	static inline void halSendBytes(uint8_t* bytes, uint16_t size) {
